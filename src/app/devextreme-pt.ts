export const xMensagens = {
  'pt-BR': {
    ...
    'dxDataGrid-columnChooserEmptyText':
      'Arraste uma coluna para até aqui para escondê-la',
    ...
    'dxDataGrid-groupPanelEmptyText':
      'Arrastar o cabeçalho de uma coluna para aqui para agrupar por essa coluna',
    ...
    'dxScheduler-confirmRecurrenceDeleteMessage':
      'Deseja eliminar só este compromisso ou a série toda?',
    ...
    'dxGantt-dialogTaskDeleteConfirmation':
      'Excluir uma tarefa também exclui suas dependências e subtarefas. Você tem certeza que quer excluir essa tarefa?',
    'dxGantt-dialogDependencyDeleteConfirmation':
      'Você tem certeza que quer excluir a dependência desta tarefa?',
    'dxGantt-dialogResourcesDeleteConfirmation':
      'Ao excluir o recurso, ele também será excluido das tarefas em que está atribuído. Tem certeza que quer excluir estes recursos? Recurso: {0}',
    'dxGantt-dialogConstraintCriticalViolationMessage':
      'A tarefa a ser movida está ligada a uma outra tarefa, por uma relação de dependência. Esta alteração conflita com as regras de dependências. Como você gostaria de proceder?',
    'dxGantt-dialogConstraintViolationMessage':
      'A tarefa a ser movida está ligada a uma outra tarefa, por uma relação de dependência. Como você gostaria de proceder?',
    ...
    'dxGantt-dialogMoveTaskAndKeepDependencyMessage':
      'Mover a tarefa e manter a dependência',
